...
export default function Hero({ typedText, showText }: { typedText: string; showText: boolean }) {
  return (
    <motion.section
      ...
      className="relative w-full bg-gradient-to-b from-gray-900 via-gray-950 to-black text-white py-20 px-6 lg:px-16 overflow-hidden"
    >
        ...
        <div className="flex flex-col space-y-6">
          <div className="flex items-center space-x-4">
            <img
              ...
              alt="Avatar"
              className="w-20 h-20 rounded-full border-2 border-cyan-500 shadow-lg"
            />
            <div>
              <h3 className="text-lg font-semibold">DANILO CAMPIONI</h3>
              <p className="text-sm text-gray-400">
                Desenvolvedor Full Stack | Experiência e Inovação
              </p>
            </div>
          </div>
