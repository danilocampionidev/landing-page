// components/ProjectStepsHybrid.tsx
"use client";
...
export default function ProjectStepsHybrid({ forceMobile }: Props) {
        ...
        <div
          ...
          className={`relative z-10 px-4 ${
            isMobile
              ...
              : "flex items-start md:items-center justify-between flex-row h-48"
          }`}
        >
          {steps.map((s, i) => (
            <motion.div
              ...
              animate={{
                scale: activeStep === i ? (isMobile ? 1.05 : 1.2) : (isMobile ? 1 : 0.75)
              }}
            >
              <motion.div
